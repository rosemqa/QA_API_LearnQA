# API testing of the LearnQA test API

This project is designed for automated API testing of the [LearnQA test API](https://playground.learnqa.ru/api/map).
...
[Allure Report on GitHub Pages](https://rosemqa.github.io/QA_API_LearnQA/)
