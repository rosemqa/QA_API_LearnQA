...
class TestUser(BaseTest):
    ...
    class TestCrateUser(BaseTest):
        ...
        @pytest.mark.parametrize('email',
                                 ['testmail.com', 'test @mail.com', 'test@mail.', 'test@mailcom', '@@mail.com'])
        @allure.tag('negative')
    ...
    @allure.feature('Login/auth user')
    class TestLoginUser(BaseTest):
        ...
        def test_login_with_wrong_credentials(self, login_default_user, check):
            ...
            with (check):
                assert wrong_password_login == 'Invalid username/password supplied', \
                    f'Check error value for wrong password'
            with check:
